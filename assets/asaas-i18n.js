...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      photo1: 'Photo 1',
      photo2: 'Photo 2',
      photoTitle2: 'Second corridor photo',
      ...
      needPhoto: 'Add at least one corridor photo.',
      needDescriptionItem: function (p) { return 'Item ' + (p.n || 1) + ': add a description or photo.'; },
      needPhotoItem: function (p) { return 'Item ' + (p.n || 1) + ': add at least one photo.'; },
    ...
    ckb: {
      ...
      photo1: 'وێنە ١',
      photo2: 'وێنە ٢',
      photoTitle2: 'وێنەی دووەمی ڕێڕەو',
      ...
      needPhoto: 'لانیکەم یەک وێنەی ڕێڕەو زیاد بکە.',
      needDescriptionItem: function (p) { return 'شت ' + (p.n || 1) + ': وەسف یان وێنە زیاد بکە.'; },
      needPhotoItem: function (p) { return 'شت ' + (p.n || 1) + ': لانیکەم یەک وێنە زیاد بکە.'; },
