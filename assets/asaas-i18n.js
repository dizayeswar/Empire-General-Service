...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      officeViewOnlyHint: 'View only. Sticker photos and returns are handled on the mobile guard app.',
      ...
      analyticsBoardTitle: 'Item register',
      analyticsDays: 'Days in warehouse',
      analyticsReturnedAt: 'Returned date',
      analyticsApartment: 'Apartment',
    ...
    ckb: {
      ...
      officeViewOnlyHint: 'تەنها بینین. وێنەی ستیکەر و گەڕاندنەوە لە ئەپی مۆبایلی پاسەوان دەکرێت.',
      ...
      analyticsBoardTitle: 'تۆماری شتەکان',
      analyticsDays: 'ڕۆژ لە کۆگا',
      analyticsReturnedAt: 'بەرواری گەڕاندنەوە',
      analyticsApartment: 'شوقە',
