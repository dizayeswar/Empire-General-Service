...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      wfrRefundableHint: 'Leave unchecked for <strong>maintenance</strong>. When checked, add an <strong>invoice photo</strong> — job photos are optional.',
      wfrRefundableNote: 'Refundable work needs an <strong>invoice photo</strong> before sending. Job photos are optional.',
      ...
      wfrNeedContent: 'Add a place, note, photo, invoice, or voice recording.',
    ...
    ckb: {
      ...
      wfrRefundableHint: 'بە بەتاڵی بهێڵە بۆ <strong>چاکسازی</strong>. کاتێک نیشانەکراوە، <strong>وێنەی پسوولە</strong> زیاد بکە — وێنەی کار ئارەزوومەندانەیە.',
      wfrRefundableNote: 'کاری گەڕانەوەی پارە پێویستی بە <strong>وێنەی پسوولە</strong> هەیە پێش ناردن. وێنەی کار ئارەزوومەندانەیە.',
      ...
      wfrNeedContent: 'شوێن، تێبینی، وێنە، پسوولە، یان تۆمارکردنی دەنگ زیاد بکە.',
    ...
    ar: {
      ...
      wfrRefundableHint: 'اتركه بدون تحديد لـ<strong>الصيانة</strong>. عند التحديد، أضف <strong>صورة الفاتورة</strong> — صور العمل اختيارية.',
      wfrRefundableNote: 'العمل القابل للاسترداد يحتاج إلى <strong>صورة الفاتورة</strong> قبل الإرسال. صور العمل اختيارية.',
      ...
      wfrNeedContent: 'أضف مكاناً أو ملاحظة أو صورة أو فاتورة أو تسجيلاً صوتياً.',
